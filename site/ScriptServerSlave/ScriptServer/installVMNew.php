...
function installVM($nameVM, $RAM, $HDDSize) {
    ...
    $return = exec(     'cp '.PATH_OVA_OS.'/'.NAME_OVA_OS.' .;'
                        ...
                        .'VBoxManage import '.NAME_OVA_OS.' --vsys 0 --vmname '.$nameVM.' --memory '.$RAM.' --unit 12 --disk '.PATH_VMS_FOLDER.$nameVM.'/'.$nameVM.'-disk1_2.vmdk --unit 4 --ignore --unit 5 --ignore --unit 6 --unit 7 --ignore --ignore  --unit 8 --ignore --unit 9 --ignore --unit 10 --ignore;'
