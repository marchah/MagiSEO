...
class ReportDAO extends DAO {
    ...
    static $tab['REPORTING'] = 'reporting';
$tab['REPORTING']['ID'] = 'id';
$tab['REPORTING']['ID_USER'] = 'iduser';
$tab['REPORTING']['TITLE'] = 'title';
$tab['REPORTING']['DESCRIPTION'] = 'description';
$tab['REPORTING']['TYPE'] = 'type';
$tab['REPORTING']['DATE'] = 'date';*/
